...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript"> var pe_Gh = "True"; var pe_mN = "pe_ta"; </script>
		...
		<td class="pe_ei">
			...
			<table id="Info">
				<tr>
					...
					<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_NY">&nbsp;</span></font></td>
					<td id="InfoText">&nbsp;</td>
				</tr>
				<tr>
		...
		<td class="pe_ei">
			...
			<table class="pe_hC">
			 <tr>
			  ...
			  <tr>
				<td id="pe_WE" style="height:20px"></td>
			  </tr>
			</table>
