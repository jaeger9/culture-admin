...
<%
	...
	String wfServerAddress="175.125.91.31"; 
	try{
		s = new Socket();
		...
		out.print("<iframe id='webfilterSmsFrame' name='webfilterSmsFrame' width='0' src='"+wfcontextRoot+"/webfilter/html/webfilterBypass.jsp' height='0' frameborder='0' scrolling='no' noresize></iframe>");
	}finally{
		if( s != null ){
			try{
				s.close();
