	...
	var nTotalSize = 0;
	var nMaxImageSize = 15*1024*1024;
	...
	function checkDragAndDropAPI(){
		...
		// 테스트 (단일 업로드 테스트 시 false로 주면 브라우저 관계없이 단일 업로드 실행)
		// bSupportDragAndDropAPI = false;
	}
    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/SE2.3.10.O11329/photo_uploader/popup/file_uploader_html5.jsp'; 	//upload URL
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	// 업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			...
 			sUrl  : '/SE2.3.10.O11329/photo_uploader/popup/file_uploader.jsp',		// 샘플 URL입니다.
