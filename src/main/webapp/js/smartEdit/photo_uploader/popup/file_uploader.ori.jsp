...
<%
	try{
		...
		String path = File.separator+"data"+File.separator+"nas"+File.separator+"upload"+File.separator+today;
...
// 		String rt = "c:\\temp";
		...
		String smartEditPath = cp + File.separator+"upload"+File.separator+today+File.separator;
