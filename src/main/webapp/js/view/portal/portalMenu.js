...
function beforeRemoveNode(treeId, treeNode) {
	...
	$.post('/portal/menu/removejson.do', param, function () {
...
function onDropNode(event, treeId, treeNodes, targetNode, moveType) {
	if (moveType != null) {
		...
		if (param != null) {
			...
			$.get('/portal/menu/sortjson.do', param, function (data) {
				setTree(function () {
					$('.new_btn').click();
					isDrop = true;
					// Layer.unmask();
...
function setTree(callback) {
	...
	$.get('/portal/menu/menujson.do', {}, function (data) {
...
function insertMenu() {
	...
	$.post('/portal/menu/insertjson.do', param, function (data) {
		setTree(function () {
			$('.new_btn').click();
