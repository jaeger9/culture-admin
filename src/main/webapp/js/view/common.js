...
var Popup = {
	uciOrg : function () {
		window.open('/popup/uciOrg.do', 'uciOrgPopup', 'width=600,height=600');
		return false;
	},
	rdfMetadata : function (value) {
		var param = '';
		if (value != undefined) {
			switch (value) {
				case '공연/전시'	:	param = '?type=06'; break;
				case '행사/축제'	:	param = '?type=50'; break;
			}
		}
		window.open('/popup/rdfMetadata.do' + param, 'rdfMetadataPopup', 'width=600,height=600');
		return false;
	},
	rdfMetadataBoth : function (value) {
		var param = '';
		if (value != undefined) {
			switch (value) {
				case '공연/전시'	:	param = '?type=06'; break;
		...
		window.open('/popup/rdfMetadataBoth.do' + param, 'rdfMetadataPopup', 'width=600,height=600');
		return false;
	},
	zipcode : function () {
		window.open('/popup/zipcode.do', 'zipcodePopup', 'width=600,height=600');
		return false;
	},
	zipcodeRoad : function () {
		window.open('/popup/zipcodeRoad.do', 'zipcodePopup', 'width=600,height=600');
		return false;
	},
	...
	fileUpload : function (menu_type, file_type) {
		window.open('/popup/fileupload.do?menu_type=' + menu_type + '&file_type=' + file_type, 'fileUploadPopup', 'width=600,height=250');
		return false;
	},
	...
	cvsFileLoad : function (menu_type, file_type) {
		window.open('/popup/cvsFileLoadPopup.do?menu_type=' + menu_type + '&file_type=' + file_type, 'cvsLoadPopup', 'width=600,height=200');
		return false;
	}
};