...
<form name="frm" method="get" action="/customer/mou/list.do">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td class="subject">
					<a href="/customer/mou/form.do?seq=${item.seq }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<%-- <span class="btn dark fr"><a href="/customer/mou/form.do?qs=${paramMap.qs }">등록</a></span> --%>
</div>
</form>
