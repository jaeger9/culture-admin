...
$(function () {
	...
	view = function(seq) { 
		url = '/cultureplan/oneview/view.do';
		if(seq)
			url += '?seq=' + seq;
	...
	updateStatus = function () {
		...
		formSubmit('/cultureplan/oneview/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/cultureplan/oneview/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/cultureplan/oneview/list.do">
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td>${num}</td>
							<td>
								<a href="/cultureplan/oneview/view.do?seq=<c:out value="${item.seq}"/>">
