...
$(function () {
	...
	if('${paramMap.cont_type}')$("select[name=cont_type]").val('${paramMap.cont_type}').attr("selected", "selected");
	...
	view = function(seq) { 
		url = '/cultureplan/prosperity/view.do';
		if(seq)
			url += '?seq=' + seq;
	...
	updateStatus = function () {
		...
		formSubmit('/cultureplan/prosperity/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/cultureplan/prosperity/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/cultureplan/prosperity/list.do">
						...
						<tr>
							...
							<td>
								<select name="cont_type">
				                    ...
				                    <option value="3">관련영상</option>
				                    <option value="4">인포그래픽</option>
