...
$(function () {
	...
	updateStatus = function () {
		...
		formSubmit('/knowledge/gukak/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/knowledge/gukak/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/knowledge/gukak/list.do">
		<input type="hidden" name="page_no" value="${paramMap.page_no }"/>
		<input type="hidden" name="updateStatus" value=""/>
		<fieldset class="searchBox">
			<legend>검색</legend>
			<div class="tableWrite">
				<table summary="국악음원자료 검색">
					<caption>국악음원자료 검색</caption>
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td>${item.live_yn}</td>
							<td>
								<a href="/knowledge/gukak/view.do?seq=<c:out value="${item.seq}"/>">
