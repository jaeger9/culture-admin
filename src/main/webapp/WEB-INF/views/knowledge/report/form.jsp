...
<form name="frm" method="POST" action="/knowledge/report/form.do" enctype="multipart/form-data">
...
<c:if test="${not empty view.uci }">
	...
	<div class="btnBox textRight">
		...
		<span class="btn gray"><a href="/knowledge/report/list.do?${paramMap.qr_dec }" class="list_btn">목록</a></span>
	</div>
