...
//		oEditors.getById['contents'].exec("UPDATE_CONTENTS_FIELD", []);
	...
	$('.upload_pop_btn').click(function () {
		Popup.fileUpload('knowledge_relic');
		return false;
	});
...
<form name="frm" method="POST" action="/knowledge/relic/form.do" enctype="multipart/form-data">
...
<c:if test="${not empty view.uci }">
	...
	<div class="btnBox textRight">
		...
		<span class="btn gray"><a href="/knowledge/relic/list.do?${paramMap.qr_dec }" class="list_btn">목록</a></span>
	</div>
