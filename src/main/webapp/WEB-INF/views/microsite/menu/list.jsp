...
<script type="text/javascript" src="/js/view/microsite/micrositeMenu.js"></script>
</head>
<body>
<script id="formTemplate" type="text/x-jquery-tmpl">
<div class="tableWrite">
	<input type="hidden" name="site_id" value="{{html site_id}}" />
	...
	<tr>
		<th scope="row">메뉴 PATH</th>
		<td>
			<input type="text" name="menu_path" value="{{html menu_path}}" maxlength="20" style="width:200px;" />
		</td>
	</tr>
	<tr>
		<th scope="row">메뉴 URL</th>
		<td>
			<input type="text" name="menu_url" value="{{html menu_url}}" maxlength="100" style="width:200px;" />
		</td>
	</tr>
	<tr>
...
<div id="mwrap">
	...
	<div class="siteWrap">
		...
		<span class="btn whiteS"><a href="#" class="search_btn">조회</a></span>
		
		<input type="hidden" name="sid" value="${paramMap.site_id }" />
	</div>
	...
	<div class="menuMng">
		...
		<div class="menuDetailWrap">
			...
			<div class="menuBtnWrap">
				...
				<span class="btn gray"><a href="/microsite/site/list.do" class="list_btn">사이트 관리</a></span>
			</div>
		</div>
	</div>
