...
<form name="frm" method="get" action="/portal/url/list.do">
		...
		<tbody>
			...
			<tr>
				...
				<td style="padding-left:15px;text-align:left;">
					<a href="/portal/url/form.do?url_id=${item.url_id }&qs=${paramMap.qs }">
						${item.url_id }
					</a>
				</td>
				<td style="padding-left:15px;text-align:left;">
				...
				<td>
					${item.approval eq 'Y' ? '승인' : '' }
					${item.approval eq 'N' ? '미승인' : '' }
				</td>
			</tr>
			</c:forEach>
		</tbody>
...
<div class="btnBox">
	...
	<span class="btn dark fr"><a href="/portal/url/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
