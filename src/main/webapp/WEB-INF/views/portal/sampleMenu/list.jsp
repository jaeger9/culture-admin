...
<script type="text/javascript" src="/js/view/portal/portalSampleMenu.js"></script>
</head>
<body>
...
<div class="tableWrite">
	...
	<tr>
		...
		<td>
			<label><input type="radio" name="menu_target" value="1" {{if menu_target == '1'}} checked="checked" {{/if}} /> 자창</label>
			<label><input type="radio" name="menu_target" value="2" {{if menu_target == '2'}} checked="checked" {{/if}} /> 새창</label>
		</td>
	</tr>
