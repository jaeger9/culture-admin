...
$(function () {
	...
	view = function(seq) { 
		url = '/education/humanLecture/view.do';
		if(seq)
			url += '?seq=' + seq;
	...
	updateStatus = function () {
		...
		formSubmit('/education/humanLecture/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/education/humanLecture/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/education/humanLecture/list.do">
		...
		<fieldset class="searchBox">
			...
			<div class="tableWrite">
				<table summary="인문학강연 검색">
					<caption>인문학강연 검색</caption>
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td>${num}</td>
							<td>
								<a href="/education/humanLecture/view.do?seq=<c:out value="${item.seq}"/>">
