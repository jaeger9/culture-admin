...
$(function () {
	...
	var ajaxApproval = function (approval) {
		...
		$.ajax({
			url			:	'/addservice/contestMcst/approval.do'
			,type		:	'post'
...
<form name="frm" method="get" action="/addservice/contestMcst/list.do">
			...
			<tr>
				...
				<td>
					<c:if test="${not empty item.image }">
						<img src="/upload/contestMCST/${item.image }" alt="${item.title }" style="width:100px; height:130px;" />
					</c:if>
				...
				<td class="subject">
					<a href="/addservice/contestMcst/form.do?seq=${item.seq }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<span class="btn dark fr"><a href="/addservice/contestMcst/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
