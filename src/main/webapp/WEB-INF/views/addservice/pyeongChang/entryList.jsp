...
<body>
	...
	<form name="frm" method="get" action="entryList.do">
		...
		<ul class="tab">
			<li>
				<a href="/addservice/pyeongChang/entryList.do?event=pyeongChang1" <c:if test="${ paramMap.event eq 'pyeongChang1' }"> class="focus"</c:if>>
					응원하기 이벤트 응모현황
				</a>
			</li>
			<li>
				<a href="/addservice/pyeongChang/entryList.do?event=pyeongChang2" <c:if test="${ paramMap.event eq 'pyeongChang2' }"> class="focus"</c:if>>
					URL공유하기 이벤트 응모현황
				</a>
			</li>
		</ul>
