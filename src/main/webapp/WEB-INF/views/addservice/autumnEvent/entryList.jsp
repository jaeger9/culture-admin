...
<!-- 		<ul class="tab"> -->
<!-- 			<li> -->
<%-- 				<a href="/addservice/autumnEvent/entryList.do?event=autumnEvent" <c:if test="${ paramMap.event eq 'autumnEvent' }"> class="focus"</c:if>> --%>
<!-- 					EVENT 1 참여관리 -->
<!-- 				</a> -->
<!-- 			</li> -->
<!-- 			<li> -->
<%-- 				<a href="/addservice/autumnEvent/entryList.do?event=autumnEventSNS" <c:if test="${ paramMap.event eq 'autumnEventSNS' }"> class="focus"</c:if>> --%>
<!-- 					EVENT 2 참여관리 -->
<!-- 				</a> -->
<!-- 			</li> -->
<!-- 		</ul> -->
				...
				<table summary="게시판 글 검색">
					...
					<tbody>
						<tr>
							...
							<td>
								<select name="event_name" items="${list }">
...
<%-- 									<option value="incomeDeductionEvent" 		<c:if test="${paramMap.event_name eq 'incomeDeductionEvent' }"		>selected</c:if>	>[2018]소득공제이벤트1</option> --%>
						...
						<tr>
							<th scope="row">등록일</th>
							<td>
								<input type="text" name="11" value="${paramMap.reg_start }" />
								<input type="text" name="ddd" value="${paramMap.reg_start }" />
								<span>~</span>
