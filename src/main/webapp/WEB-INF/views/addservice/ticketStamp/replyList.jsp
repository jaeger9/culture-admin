...
<script type="text/javascript">
	...
	$(function() {
		...
		$('.delete_btn').click(function () {
			...
			$.ajax({
				url			:	'/addservice/ticketStamp/replyDelete.do'
				,type		:	'post'
...
<body>
	...
	<form name="frm" method="get" action="replyList.do">
		...
		<ul class="tab">
			<li>
				<a href="/addservice/ticketStamp/replyList.do?gubun=ticketStamp1" <c:if test="${ paramMap.gubun eq 'ticketStamp1' }"> class="focus"</c:if>>
					문화 영상감상 이벤트 댓글관리
				</a>
			</li>
			<li>
				<a href="/addservice/ticketStamp/replyList.do?gubun=ticketStamp2" <c:if test="${ paramMap.gubun eq 'ticketStamp2' }"> class="focus"</c:if>>
					문화 공유 이벤트 댓글관리
				</a>
			</li>
		</ul>
