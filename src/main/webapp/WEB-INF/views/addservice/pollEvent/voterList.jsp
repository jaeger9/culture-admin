...
$(function() {
	...
	$('button[name=searchButton]').click(function(){
		$('form[name=frm]').attr('action', 'voterList.do').submit();
...
function winnerPopup() {
	window.open('pollWinnerPopup.do', '', 'scrollbars=yes,width=600,height=580');
}
</script>
</head>
<body>
				...
				<table summary="게시판 글 검색">
					...
					<tbody>
						...
						<tr>
							<th scope="row">회차</th>
							<td>
								<input type="text" name="search_event_number" title="검색어 입력" value="${paramMap.search_event_number}"/>
							</td>
						</tr>
						<tr>
							<th scope="row">검색어</th>
