...
<script type="text/javascript">
	$(function () {
		...
		entry_month.change(function (){
			location.href="/addservice/pollEvent/commentWinnerPopup.do?entry_month="+$(this).val();
...
<form name="frm" method="post" action="/addservice/pollEvent/commentWinnerPopup.do" style="padding:20px;">
<fieldset>
				...
				<tr>
					...
					<td>
						<select name="entry_month" style="background-color: white; width: 100px;">
							...
							<c:forEach items="${commentMonthList }" var="list" varStatus="status">
