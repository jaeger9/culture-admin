...
<body>
	...
	<form name="frm" method="get" action="entryList.do">
		...
		<ul class="tab">
			<li>
				<a href="/addservice/chuseokEvent/entryList.do?event=chuseokEvent" <c:if test="${ paramMap.event eq 'chuseokEvent' }"> class="focus"</c:if>>
					EVENT 1 참여관리
				</a>
			</li>
			<li>
				<a href="/addservice/chuseokEvent/entryList.do?event=chuseokEventSNS" <c:if test="${ paramMap.event eq 'chuseokEventSNS' }"> class="focus"</c:if>>
					EVENT 2 참여관리
				</a>
			</li>
		</ul>
