...
$(function () {
	...
	var ajaxApproval = function (approval) {
		...
		$.ajax({
			url			:	'/addservice/contestNotice/approval.do'
			,type		:	'post'
...
<form name="frm" method="get" action="/addservice/contestNotice/list.do">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td class="subject">
					<a href="/addservice/contestNotice/form.do?seq=${item.seq }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<span class="btn dark fr"><a href="/addservice/contestNotice/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
