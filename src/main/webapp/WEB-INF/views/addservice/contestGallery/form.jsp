...
var callback = {
	fileUpload : function (res) {
		...
		$('.upload_pop_img').html('<img src="/upload/contestGallery/' + res.file_path + '" width="202" height="146" alt="" />');
	}
};
...
$(function () {
	...
	$('.upload_pop_btn').click(function () {
		Popup.fileUpload('addservice_contestGallery');
		return false;
	});
	...
	if ($('.delete_btn').size() > 0) {
		$('.delete_btn').click(function () {
			...
			$.ajax({
				url			:	'/addservice/contestGallery/delete.do'
				,type		:	'post'
...
<form name="frm" method="POST" action="/addservice/contestGallery/form.do" enctype="multipart/form-data">
...
<c:if test="${not empty view.seq }">
				...
				<tr>
					...
					<td colspan="3">
						...
						<div class="upload_pop_msg">(202px * 146px 크기의 이미지를 선택해 주세요.)</div>
						<div class="upload_pop_img">
							<c:if test="${not empty view.image }">
								<img src="/upload/contestGallery/${view.image }" width="202" height="146" alt="" />
							</c:if>
						</div>
					</td>
				</tr>
	...
	<div class="btnBox textRight">
		...
		<span class="btn gray"><a href="/addservice/contestGallery/list.do?${paramMap.qr_dec }" class="list_btn">목록</a></span>
	</div>
