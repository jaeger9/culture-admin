...
$(function () {
	...
	var ajaxApproval = function (approval) {
		...
		$.ajax({
			url			:	'/addservice/contestGallery/approval.do'
			,type		:	'post'
...
<form name="frm" method="get" action="/addservice/contestGallery/list.do">
			...
			<tr>
				...
				<td>
					<c:if test="${not empty item.image }">
						<img src="/upload/contestGallery/${item.image }" alt="${item.title }" style="width:130px; height:100px;" />
					</c:if>
				...
				<td class="subject">
					<a href="/addservice/contestGallery/form.do?seq=${item.seq }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<span class="btn dark fr"><a href="/addservice/contestGallery/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
