...
$(function () {
	...
	var ajaxApproval = function (approval) {
		approval = (approval == 'Y' ? 'Y' : (approval == 'W' ? 'W' : 'N'));
		var approvalText = (approval == 'Y' ? '승인' : (approval == 'W' ? '대기' : '미승인'));
		...
		$.ajax({
			url			:	'/resource/banner/approval.do'
			,type		:	'post'
...
/* 	page_seq.change(function () {
		...
		if ($(this).val() != '') {
			$.get('/resource/banner/menujson.do', {page_seq : $(this).val()}, function (data) {
...
<form name="frm" method="get" action="/resource/banner/list.do">
		...
		<table summary="게시판 글 검색">
			...
			<tbody>
				<tr>
					...
					<td colspan="3">
						<select name="page_seq" style="width:250px;">
				...
				<tr>
					...
					<td>
						<select name="approval" style="width:150px;">
							<option value="">전체</option>
							...
							<option value="W" ${paramMap.approval eq 'W' ? 'selected="selected"' : '' }>대기</option>
						</select>
					</td>
					<th scope="row">검색어</th>
					<td>
						<input type="text" name="search_word" value="${paramMap.search_word }" style="width:270px;" />
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td class="subject">
					<a href="/resource/banner/form.do?seq=${item.seq }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<span class="btn white"><a href="#" class="approval_w_btn">대기</a></span>
	<span class="btn white"><a href="#" class="approval_n_btn">미승인</a></span>
	<span class="btn white"><a href="#" class="delete_btn">삭제</a></span>
	<span class="btn dark fr"><a href="/resource/banner/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
