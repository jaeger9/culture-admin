...
/* 	
	...
	console.log("cul_place== " + cul_place);
	console.log("cul_place2== " + cul_place2);
...
<body>
	...
	<div class="tableWrite">
		<form name="frm" method="post" action="/facility/place/insert.do" enctype="multipart/form-data">
			...
			<input type="text" value="${view.cul_place}" name="cul_place">
			<input type="text" value="${view.cul_place2}" name="cul_place2">
