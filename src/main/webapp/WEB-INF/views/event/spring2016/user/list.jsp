...
<script type="text/javascript">
	...
	function winnerPopup() {
		window.open('winnerLotPopup.do?wtype=TRIP', 'winnerLotPopup', 'scrollbars=yes,width=600,height=630');
	}
	function winnerPopup2() {
		window.open('winnerLotPopup.do?wtype=ATT', 'winnerLotPopup', 'scrollbars=yes,width=600,height=630');
	}
...
<body>
	...
	<div class="btnBox">
		...
		<span class="btn dark fr" style="margin-right:4px;"><a href="#url" onclick="winnerPopup();return false;">휴가상 당첨자 추첨</a></span>
		<span class="btn dark fr" style="margin-right:4px;"><a href="#url" onclick="winnerPopup2();return false;">출석경품 당첨자 추첨</a></span>
	</div>
