...
<form name="frm" method="get" action="/event/job/list.do">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td class="subject">
					<a href="/event/job/form.do?uci=${item.uci }&qs=${paramMap.qs }">
						${item.title }
					</a>
				</td>
				<td>
...
<div class="btnBox">
	...
	<span class="btn dark fr"><a href="/event/job/form.do?qs=${paramMap.qs }">등록</a></span>
</div>
</form>
