...
<fieldset class="searchBox">
	<legend>복주머니 이벤트 당첨자 추첨</legend>
	<div class="tableWrite">
		<table summary="복주머니 이벤트 당첨자 추첨">
			<caption>복주머니 이벤트 당첨자 추첨</caption>
			<colgroup>
				<col />
			</colgroup>
			<tbody>
				<tr>
					<th scope="row">복주머니 이벤트 당첨자 추첨</th>
				</tr>
			</tbody>
		</table>
	</div>
...
<!-- table list -->
<div class="tableList">
	<table summary="복주머니 이벤트 당첨자">
		<caption>복주머니 이벤트 당첨자</caption>
		<colgroup>
			<col style="width:8%" />
			<col style="width:20%" />
			<col style="width:15%" />
		...
		<c:forEach var="item" items="${winnerList }">
			<tr>
				<td><input type="checkbox" name="chkbox_id" value="${item.user_id }" /></td>
				<td><c:out value="${item.user_id }"/></td>
				<td><c:out value="${item.user_nm }"/></td>
				<td><c:out value="${item.user_email }"/></td>
