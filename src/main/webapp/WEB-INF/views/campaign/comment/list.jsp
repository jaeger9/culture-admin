...
<script type="text/javascript">
	...
	function winnerLotPopup() {
		window.open('popup/winnerList.do', 'winnerPopup', 'scrollbars=yes,width=600,height=630');
	}
...
<body>
			...
			<table summary="게시판 글 목록">
				...
				<c:forEach var="item" items="${list }" varStatus="status">
					...
					<tr>
						...
						<td>${num }</td>
						<td>${item.event_nm }</td>
						<td class="subject"><a href="view.do?seq=${item.seq }"><c:out value="${item.comment_contents}"/></a></td>
	...
	<div class="btnBox">
		...
		<span class="btn dark fr" style="margin-right:4px;"><a href="#url" onclick="winnerLotPopup();return false;">당첨자 추첨</a></span>
	</div>
