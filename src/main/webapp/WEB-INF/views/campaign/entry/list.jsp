			...
			<table summary="게시판 글 목록">
				...
				<c:forEach var="item" items="${list }" varStatus="status">
					...
					<tr>
						<td>${num }</td>
						<td>${item.event_nm }</td>
						<td><a href="view.do?seq=${item.seq }"><img src="/${item.file_path }/${item.sys_file_nm }" /></a></td>
						<td class="subject"><a href="view.do?seq=${item.seq }"><c:out value="${item.contents}"/></a></td>
