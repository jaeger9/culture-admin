		...
		<div class="tableWrite">	
			<table summary="캠페인 참여자 컨텐츠 작성">
				...
				<tbody>
					...
					<tr>
						<th scope="row">등록일</th>
						<td colspan="3">${view.reg_date }</td>
					</tr>
					<tr>
						<th scope="row" rowspan="2">제목</th>
						<td>사진이벤트</td>
						<th>참여횟수</th>
						<td>${view.entry_cnt }</td>
					</tr>
					<tr>
						<td>댓글이벤트</td>
						<th>참여횟수</th>
						<td>${view.comment_cnt }</td>
					</tr>
					<tr>
						<th scope="row">비고</th>
						<td colspan="3">
							<textarea name="note" style="width:100%;height:200px;">${fn:replace(view.note, br, crcn) }</textarea>
						</td>	
					</tr>
				</tbody>
			</table>
