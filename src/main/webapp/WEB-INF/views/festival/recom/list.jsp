...
$(function () {
	...
	view = function(seq) { 
		url = '/festival/recom/' + menuType.val() + '/view.do';
		if(seq)
			url += '?seq=' + seq;
	...
	updateStatus = function () {
		...
		formSubmit('/festival/recom/' + menuType.val() + '/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/festival/recom/' + menuType.val() + '/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/festival/recom/${paramMap.menuType}/list.do">
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td>${num}</td>
							<td>
								<a href="/festival/recom/${paramMap.menuType}/view.do?seq=<c:out value="${item.seq}"/>">
