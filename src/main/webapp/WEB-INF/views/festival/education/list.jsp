...
$(function () {
	...
	view = function(uci) { 
		url = '/festival/education/view.do';
		if(uci)
	...
	updateStatus = function () {
		...
		formSubmit('/festival/education/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/festival/education/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/festival/education/list.do">
