...
$(function () {
	...
	updateStatus = function () {
		...
		formSubmit('/magazine/cardnews/statusUpdate.do');
	}
	...
	deleteSites = function () {
		...
		formSubmit('/magazine/cardnews/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/magazine/cardnews/list.do">
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td>${num}</td>
							<td class="subject">
								<a href="/magazine/cardnews/view.do?seq=${item.seq}">
