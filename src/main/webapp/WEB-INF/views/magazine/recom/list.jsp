...
$(function () {
	...
	updateStatus = function () {
		...
		formSubmit('/magazine/recom/statusUpdate.do');
	}
	...
	deleteSites = function () { 
		...
		formSubmit('/magazine/recom/delete.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/magazine/recom/list.do">
