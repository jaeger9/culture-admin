...
<form name="frm" method="get" action="/popup/rdfMetadataEvent.do" style="padding:20px;">
...
<div class="tableList">
	<ul class="tab">
		<li>
			<a href="/popup/rdfMetadataFestival.do">축제</a>
		</li>
		<li>
			<a href="/popup/rdfMetadataEvent.do" class="focus">행사</a>
		</li>
	</ul>
