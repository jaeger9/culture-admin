...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.culturegroup) {
			window.opener.callback.culturegroup( data );
		} else 
...
<form name="frm" method="get" action="/popup/culturegroup.do" style="padding:20px;">
