...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.hiring) {
			window.opener.callback.hiring( data );
		} else 
...
<form name="frm" method="get" action="/popup/hiring.do" style="padding:20px;">
