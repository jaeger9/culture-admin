...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.rdfMetadataBoth) {
			window.opener.callback.rdfMetadataBoth( data );
		}
...
<form name="frm" method="get" action="/popup/rdfMetadataBoth.do" style="padding:20px;">
