...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.relic) {
			window.opener.callback.relic ( data );
		}
...
<form name="frm" method="get" action="/popup/relic.do" style="padding:20px;">
