...
<form name="frm" method="get" action="/popup/culturerecom.do" style="padding:20px;">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr
				...
				data-url="${item.url}"
				data-summary="<tags:out text='${item.summary}' defaultValue='-' byteLength='400' ellipsis='...' removeXml='true' escapeXml='true'/>"
				data-content="<tags:out text='${item.summary}' defaultValue='-' byteLength='400' ellipsis='...' removeXml='true' escapeXml='true'/>"
			>
				<td>
