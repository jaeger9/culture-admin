...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.relayGroup) {
			window.opener.callback.relayGroup( data );
		} else 
...
<form name="frm" method="get" action="/popup/relayGroup.do" style="padding:20px;">
