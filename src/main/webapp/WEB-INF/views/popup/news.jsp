...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.news) {
			window.opener.callback.news( data );
		} else 
...
<form name="frm" method="get" action="/popup/news.do" style="padding:20px;">
		...
		<tbody>
			...
			<c:forEach items="${list }" var="item" varStatus="status">
				...
				<tr
					...
					data-image-name="${item.reference_identifier}"
				>
					<td>${num}</td>
					<td class="subject">
