...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.ucc) {
			window.opener.callback.ucc( data );
		}
...
<form name="frm" method="get" action="/popup/ucc1.do" style="padding:20px;">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr
				...
				data-url="${item.url}" 
				data-summary="<tags:out text='${item.summary}' defaultValue='-' byteLength='1000' ellipsis='...' removeXml='true' escapeXml='true'/>"
				>
				<td>
