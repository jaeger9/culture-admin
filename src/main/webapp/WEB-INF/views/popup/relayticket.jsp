...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.relayticket) {
			window.opener.callback.relayticket( data );
		} else 
...
<form name="frm" method="get" action="/popup/relayticket.do" style="padding:20px;">
		...
		<tbody>
			...
			<c:forEach items="${list }" var="item" varStatus="status">
				...
				<tr
					...
					data-url="/perform/performView.do?uci=${item.uci}"
					data-uci="${item.uci}"
