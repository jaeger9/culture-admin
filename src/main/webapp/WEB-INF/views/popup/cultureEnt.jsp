			...
			<c:forEach items="${list }" var="item" varStatus="status">
				...
				<tr id="trData${status.index}" style="display:none;">
					<td>
						...
						<input type="hidden" id="image${status.index}" name="image"	value="${item.file_name }" />
						<input type="hidden" id="url${status.index}" name="url"	value="${item.url }" />
						<input type="hidden" id="new_win_yn${status.index}" name="new_win_yn"	value="${item.new_win_yn }" />
					</td>
				</tr>
			</c:forEach>
		</tbody>
