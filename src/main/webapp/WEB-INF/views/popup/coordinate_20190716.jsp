		...
		$('span a').each(function(){
			$(this).click(function(){
			    if($(this).html() == '적용하기'){
			    	...
			    	console.log("detailAddr22=== " + detailAddr22);
			    	if(detailAddr22 == null || detailAddr22 == ""){
			    		detailAddr22 = addr;
			    	}
		    		...
		    		var culaddr = detailAddr22.split(' ');
		    		var sido1 = culaddr[0];
		    		var gugun1 = culaddr[1];
		    		
		    		var sido = window.opener.document.getElementById("sido");
		    		var gugun = window.opener.document.getElementById("gugun");
		    		
		    		if(sido){
		    			window.opener.document.getElementById("sido").value = sido1;
		    		}
		    		
		    		if(gugun){
		    			window.opener.document.getElementById("gugun").value = gugun1;
		    		}

		    		
		    		var address = window.opener.document.getElementById("address"); 
		    		if(address) { 
		    			window.opener.document.getElementById("address").value = detailAddr22;
		    		}  
