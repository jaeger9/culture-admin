...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.notice) {
			window.opener.callback.notice( data );
		} else 
...
<form name="frm" method="get" action="/popup/notice.do" style="padding:20px;">
