...
<div class="tableList">
	<ul class="tab">
		<li>
			<a href="/popup/cultureExp.do?subType=&type=ucc" ${empty paramMap.subType ? 'class="focus"':''}>문화영상</a>
		</li>
<%-- 		<li>
			<a href="/popup/cultureExp.do?subType=0&type=ucc" ${paramMap.subType == '0' ? 'class="focus"':''}>국내영상</a>
		</li>
		<li>
			<a href="/popup/cultureExp.do?subType=1&type=ucc" ${paramMap.subType == '1' ? 'class="focus"':''}>국외영상</a>
		</li>
		<li>
			<a href="/popup/cultureExp.do?subType=2&type=ucc" ${paramMap.subType == '2' ? 'class="focus"':''}>기타영상</a>
		</li> --%>
	</ul>
