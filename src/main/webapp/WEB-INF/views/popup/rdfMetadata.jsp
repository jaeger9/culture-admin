...
<form name="frm" method="get" action="/popup/rdfMetadata.do" style="padding:20px;">
				...
				<tr>
					...
					<td>
						<select name="type">
							...
							<option value="06" ${paramMap.type eq '06' ? 'selected="selected"' : '' }>공연/전시</option>
							<option value="50" ${paramMap.type eq '50' ? 'selected="selected"' : '' }>행사/축제</option>
						</select>
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr
				...
				<td>
					<a href="#">
						<c:if test="${fn:indexOf(item.type, '06') > -1 }">공연/전시</c:if>
						<c:if test="${fn:indexOf(item.type, '50') > -1 }">행사/축제</c:if>
					</a>
				</td>
				<td class="subject">
					<a href="#">
