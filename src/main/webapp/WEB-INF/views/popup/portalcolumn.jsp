...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.portalcolumn) {
			window.opener.callback.portalcolumn( data );
		} else 
...
<form name="frm" method="get" action="/popup/portalcolumn.do" style="padding:20px;">
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr
				...
				data-image="/upload/recom/recom/${item.img_url}" , 
