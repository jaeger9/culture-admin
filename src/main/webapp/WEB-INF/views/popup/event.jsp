...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.event) {
			window.opener.callback.event( data );
		}
...
<form name="frm" method="get" action="/popup/ucc.do" style="padding:20px;">
