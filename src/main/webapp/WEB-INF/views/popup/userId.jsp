...
$(function () {
	...
	$('.user_id_btn').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.userId) {
			window.opener.callback.userId( data );
		}
...
<form name="frm" method="get" action="/popup/userId.do" style="padding:20px;">
