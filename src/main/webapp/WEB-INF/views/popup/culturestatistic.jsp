...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.culturestatistic) {
			window.opener.callback.culturestatistic( data );
		} else 
...
<form name="frm" method="get" action="/popup/culturestatistic.do" style="padding:20px;">
