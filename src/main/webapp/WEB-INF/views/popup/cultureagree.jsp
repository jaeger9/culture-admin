...
$(function () {
	...
	$('.tableList a').click(function () {
		...
		if (window.opener && window.opener.callback && window.opener.callback.cultureagree) {
			window.opener.callback.cultureagree( data );
		} else 
...
<form name="frm" method="get" action="/popup/cultureagree.do" style="padding:20px;">
		...
		<tbody>
			...
			<c:forEach items="${list }" var="item" varStatus="status">
				...
				>
					...
					<td>
						<a href="#">
							<c:out value="${item.source_name}"/>
						</a>
					</td>
					<td>
						<a href="#">
							<c:out value="${item.reg_date}"/>
						</a>
					</td>
				</tr>
			</c:forEach>
