...
$(function () {
	...
	view = function(seq) { 
		url = '/culturepro/culturePop/view.do';
		if(seq)
			url += '?seq=' + seq;
	...
	updateStatus = function () {
		...
		formSubmit('/culturepro/culturePop/statusUpdate.do');
	}
...
<body>
	<!-- 검색 필드 -->
	<form name="frm" method="get" action="/culturepro/culturePop/list.do">
				...
				<tbody>
					<c:forEach items="${list }" var="item" varStatus="status">
						...
						<tr>
							...
							<td class="subject">
								<a href="/culturepro/culturePop/view.do?seq=${item.seq}">
