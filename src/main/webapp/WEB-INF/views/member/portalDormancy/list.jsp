...
<div class="topBehavior">
	...
	<p style="text-align: right;">업데이트 시간 [ <span style="font-style: bold;">${ batchUpdateDate }</span> ]</p>
</div>
	...
	<table summary="게시판 글 목록">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<c:out value="${item.dormancy_date }" default="-" />
				</td>
				<td>
					<c:out value="${item.join_date }" default="-" />
				</td>
				<td>
					<c:out value="${item.login_date }" default="-" />
				</td>
			</tr>
			</c:forEach>
		</tbody>
