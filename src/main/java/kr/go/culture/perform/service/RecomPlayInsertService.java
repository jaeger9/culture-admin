...
@Service("PerformRecomPlayInsertService")
public class RecomPlayInsertService {

	private static final Logger logger = LoggerFactory.getLogger(RecomPlayInsertService.class);
