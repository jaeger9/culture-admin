...
@Service("PerformRecomDisplayUpdateService")
public class RecomDisplayUpdateService {

	private static final Logger logger = LoggerFactory.getLogger(RecomDisplayUpdateService.class);
	...
	public void update(ParamMap paramMap, MultipartFile[] multis, String pseq) throws Exception {
	...
	private List<HashMap<String, Object>> getRecomSubList(ParamMap paramMap) throws Exception {
	...
	// private List<RecomSub> getRecomSubList(ParamMap paramMap) {
	private List<HashMap<String, Object>> getRecomSubListInsert(ParamMap paramMap, Object pseq, int maxSeq, int rowNum) throws Exception {
		int listSize = paramMap.getArray("s_seq").length;
