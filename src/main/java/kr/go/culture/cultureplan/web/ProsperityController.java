...
import kr.go.culture.customer.web.SnsController;
...
@RequestMapping("/cultureplan/prosperity")
@Controller("ProsperityController")
public class ProsperityController {
	...
	public String list(HttpServletRequest request, ModelMap model)
		...
		model.addAttribute("count",
				(Integer) ckDatabaseService.readForObject("prosperity.listCnt", paramMap));
		model.addAttribute("list",
				ckDatabaseService.readForList("prosperity.list", paramMap));

		return "/cultureplan/prosperity/list";
	}
