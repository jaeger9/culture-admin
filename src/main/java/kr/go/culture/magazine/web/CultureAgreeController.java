...
@RequestMapping("/magazine/cultureagree")
@Controller("CultureAgreeController")
public class CultureAgreeController {
	...
	public String list(HttpServletRequest request, ModelMap model) throws Exception {
		...
		return "/magazine/cultureagree/list";
	}
	...
	public String view(HttpServletRequest request, ModelMap model) throws Exception {
		...
		return "/magazine/cultureagree/view";
	}
	...
	public String statusUpdate(HttpServletRequest request, ModelMap model) throws Exception {
		...
		return "forward:/magazine/cultureagree/list.do";
	}
	...
	throws Exception {
		...
		return "redirect:/magazine/cultureagree/list.do";
	}
