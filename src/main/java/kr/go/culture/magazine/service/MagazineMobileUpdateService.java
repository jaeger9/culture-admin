...
@Service("MagazineMobileUpdateService")
public class MagazineMobileUpdateService {
...
//	@Value("#{contextConfig['file.upload.base.location.dir']}")
	...
	public void Mupdate(ParamMap paramMap) throws Exception {
		...
		//String cont="";
		seq=paramMap.getInt("seq");
		cont=paramMap.getString("contents");
		tableGubun=(String)paramMap.get("gubun");
...
*/
	...
	public void CallCont() throws Exception {
		...
		if("issue".equals(tableGubun)){
		ckDataBaseService.save("culture.issue.updateMDesc", paramMap);
		}else if("cardNews".equals(tableGubun)){
			ckDataBaseService.save("cardnews.updateMDesc", paramMap);
		}
		
		System.out.println(":::ShowMUpdateService:::ShowMUpdateService_OK:::::"+tableGubun);
	}
	
	@Transactional(value = "ckTransactionManager", rollbackFor = { Exception.class })
	public void MdescUpdate(ParamMap paramMap,String tableGubun) throws Exception {
