 ...
 *
 */
@RequestMapping("/addservice/ticketStamp")
@Controller
public class TicketStampEventController {
	
	private static final Logger logger = LoggerFactory.getLogger(TicketStampEventController.class);
	...
	@RequestMapping("/entryList.do")
	 public String entryList(HttpServletRequest request, ModelMap model) throws Exception {
	    ...
	    if ((paramMap.get("event") == null) || (paramMap.get("event").equals(""))) {
	      paramMap.put("event", "ticketStamp1_1");
	    }
	    ...
	    return "/addservice/ticketStamp/entryList";
	  }
	  ...
	  public String eventState(HttpServletRequest request, ModelMap model) throws Exception {
	    ...
	    return "/addservice/ticketStamp/eventState";
	  }
