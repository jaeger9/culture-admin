...
@Service("FacilityMobileUpdateService")
public class FacilityMobileUpdateService {
	...
	public void Mupdate(ParamMap paramMap) throws Exception {
		...
		//String cont="";
		seq=paramMap.getInt("cul_seq");
		cont=paramMap.getString("cul_cont");
...
*/
	...
	public void CallCont() throws Exception {
		...
		ckDataBaseService.save("place.updateMDesc", paramMap);
	...
	public void MdescUpdate(ParamMap paramMap) throws Exception {
		...
		paramMap.put("seq",paramMap.getInt("cul_seq"));
		ckDataBaseService.save("place.updateMDesc", paramMap);
