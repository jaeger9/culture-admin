...
@Service("RecomFestivalUpdateService")
public class RecomFestivalUpdateService {

	private static final Logger logger = LoggerFactory.getLogger(RecomFestivalUpdateService.class);
