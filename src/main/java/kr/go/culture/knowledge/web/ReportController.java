...
@RequestMapping("/knowledge/report")
@Controller
public class ReportController {
	...
	private CuldataDatabaseService service;

	@RequestMapping("/list.do")
	public String list(HttpServletRequest request, ModelMap model) throws Exception {
		ParamMap paramMap = new ParamMap(request);
		paramMap.put("type", "47");

		ParamMap topParam = new ParamMap();
		topParam.put("type", "47");
	...
	public String form(HttpServletRequest request, ModelMap model) throws Exception {
		...
		if (paramMap.isNotBlank("uci")) {
			...
			if (resultMap == null) {
				...
				return "redirect:/knowledge/report/list.do";
			}
		}
	...
	public String merge(HttpServletRequest request, ModelMap model) throws Exception {
		...
		return "redirect:/knowledge/report/form.do?uci=" + paramMap.getString("uci").replace("+", "%2b") + "&qs=" + paramMap.getQREnc();
	}
